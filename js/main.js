$(document).ready(function () {
  ...
  var counterUp = $(".counter-up");   // кнопка для величения этажа (выше)
  var counterDown = $(".counter-down");  // кнопка для уменьшения этажа (выше)
  var modal = $('.modal');
  ...
  viewFlatsButton.on('click', toggleModal); // открытие модального окна при клике на кнопку "смотреть квартиры на этаже"
